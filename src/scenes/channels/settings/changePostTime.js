        ...
        if (time) {
            ...
            if (time.length > 0 && time.length < 3) {
                ...
                if (Number(minutes) > 59) {
                    return await ctx.reply("Вы можете указать минуты только до 60 мин. Пришлите мне новое время жизни поста!")
                }

                if (Number(hours) < 1) {
                    return await ctx.reply("Минимальное евремя жизни поста - 1 час. Пришлите мне новое время жизни поста!")
                }
